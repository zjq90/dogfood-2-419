...
<head>
    ...
    <meta name="description" content="豆瓣黑名单管理">
    <title>黑名单管理 - 豆瓣</title>
    ...
    <header class="main-header">
        <div class="main-header__inner">
            ...
            <form class="search-form" action="FriendListServlet?method=search_blacklist&currentPage=1" method="post" role="search">
                <label for="search-content" class="sr-only">搜索黑名单用户</label>
        ...
        <div class="main-content__wrapper">
            <section class="main-content__primary">
                <header class="user-list-header">
                    <h1 class="user-list-header__title">黑名单</h1>
                </header>
                    ...
                    <c:choose>
                        <c:when test="${not empty requestScope.p.objects}">
                            <c:forEach items="${requestScope.p.objects}" var="u">
                                <article class="user-card">
                                    <img src="${u.portrait}" alt="${u.nickname}的头像" class="user-card__avatar user-card__avatar--grayscale" loading="lazy">
                                    <div class="user-card__info">
                                        <h2 class="user-card__name user-card__name--muted">${u.nickname}</h2>
                                    ...
                                    <div class="user-card__actions">
                                        <a href="FriendListServlet?pre_method=remove_black&method=blacklist_list&toUserId=${u.userId}&currentPage=${requestScope.p.currentPage}" 
                                           class="user-card__action user-card__action--success">
                                            移出黑名单
                                        </a>
                                    </div>
                                </article>
                        ...
                        <c:otherwise>
                            <div class="empty-state">
                                <p class="empty-state__text">黑名单为空</p>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
