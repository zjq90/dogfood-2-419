...
<head>
    ...
    <meta name="description" content="豆瓣我的好友">
    <title>我的好友 - 豆瓣</title>
    ...
    <link rel="stylesheet" href="/iDouBan/css/friend.css">
...
<body class="user-list-page">
    ...
    <header class="main-header">
        <div class="main-header__inner">
            ...
            <form class="search-form" action="FriendListServlet?method=search_friend&currentPage=1" method="post" role="search">
                <label for="search-content" class="sr-only">搜索好友</label>
        ...
        <div class="main-content__wrapper">
            <section class="main-content__primary">
                <header class="user-list-header">
                    <h1 class="user-list-header__title">我的好友</h1>
                </header>
                
                <nav class="group-tabs" aria-label="好友分组">
                    <a href="/iDouBan/FriendListServlet?method=friend_list" class="group-tabs__tab group-tabs__tab--active">全部</a>
                    <c:forEach items="${requestScope.groupNames}" var="g">
                        <a href="FriendListServlet?method=search_friend_group&search_content=${g}&currentPage=1" class="group-tabs__tab">${g}</a>
                    </c:forEach>
                </nav>
                    ...
                    <c:choose>
                            ...
                            <c:forEach items="${requestScope.p.objects}" var="u">
                                <article class="user-card">
                                    ...
                                    <div class="user-card__actions">
                                        ...
                                        <a href="FriendListServlet?pre_method=unfollow&method=friend_list&toUserId=${u.userId}&currentPage=${requestScope.p.currentPage}" 
                                        ...
                                        <select class="user-card__group-select" aria-label="选择分组">
                        ...
                        <c:otherwise>
                            <div class="empty-state">
                                <p class="empty-state__text">暂无好友</p>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
