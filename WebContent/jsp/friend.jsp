    ...
    <main class="user-list-container" role="main">
        <div class="user-list-main">
            <header class="user-list-header">
                <h1 class="user-list-title">我的好友</h1>
            </header>

            <section class="user-list" aria-label="好友列表">
                <c:forEach items="${requestScope.p.objects}" var="u">
                    <article class="user-list__item">
                        ...
                        <div class="user-list__actions">
                            ...
                            <a href="FriendListServlet?pre_method=unfriend&method=friend_list&toUserId=${u.userId}&currentPage=${requestScope.p.currentPage}" 
                               class="user-list__action user-list__action--danger">
                                解除好友
                            </a>
                        </div>
                    </article>
